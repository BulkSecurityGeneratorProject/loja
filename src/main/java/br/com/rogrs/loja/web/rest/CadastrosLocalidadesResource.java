...
public class CadastrosLocalidadesResource {
    ...
    public ResponseEntity<CadastrosLocalidades> createCadastrosLocalidades(@Valid @RequestBody CadastrosLocalidades cadastrosLocalidades) throws URISyntaxException {
        ...
        if (cadastrosLocalidades.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new cadastrosLocalidades cannot already have an ID")).body(null);
        }
    ...
    @Timed
    public ResponseEntity<List<CadastrosLocalidades>> getAllCadastrosLocalidades(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<CadastrosLocalidades>> searchCadastrosLocalidades(@RequestParam String query, @ApiParam Pageable pageable) {
