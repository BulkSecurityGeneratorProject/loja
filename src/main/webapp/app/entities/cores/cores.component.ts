...
export class CoresComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Cores) {
        return item.id;
    }
    registerChangeInCores() {
        this.eventSubscriber = this.eventManager.subscribe('coresListModification', (response) => this.reset());
    }
