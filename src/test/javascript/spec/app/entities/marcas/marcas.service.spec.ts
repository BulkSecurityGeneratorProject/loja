...
describe('Service Tests', () => {
    ...
    describe('Marcas Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MarcasService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/marcas/' + 123);
            });
            it('should return Marcas', () => {

                let entity: Marcas;
                service.find(123).subscribe((_entity: Marcas) => {
                    entity = _entity;
                });
