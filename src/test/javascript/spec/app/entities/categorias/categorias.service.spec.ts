    ...
    describe('Categorias Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/categorias/' + 123);
            });
            it('should return Categorias', () => {

                let entity: Categorias;
                service.find(123).subscribe((_entity: Categorias) => {
                    entity = _entity;
                });
