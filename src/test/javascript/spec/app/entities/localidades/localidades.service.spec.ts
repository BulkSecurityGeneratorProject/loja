...
describe('Service Tests', () => {
    ...
    describe('Localidades Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LocalidadesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/localidades/' + 123);
            });
            it('should return Localidades', () => {

                let entity: Localidades;
                service.find(123).subscribe((_entity: Localidades) => {
                    entity = _entity;
                });
