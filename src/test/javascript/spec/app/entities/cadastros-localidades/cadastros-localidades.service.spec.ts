...
describe('Service Tests', () => {
    ...
    describe('CadastrosLocalidades Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CadastrosLocalidadesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/cadastros-localidades/' + 123);
            });
            it('should return CadastrosLocalidades', () => {

                let entity: CadastrosLocalidades;
                service.find(123).subscribe((_entity: CadastrosLocalidades) => {
                    entity = _entity;
                });
