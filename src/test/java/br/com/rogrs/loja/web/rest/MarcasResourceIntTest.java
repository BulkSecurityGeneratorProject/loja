...
public class MarcasResourceIntTest {
    ...
    public void createMarcas() throws Exception {
        ...
        assertThat(marcasEs).isEqualToIgnoringGivenFields(testMarcas);
    }
    ...
    public void updateMarcas() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedMarcas are not directly saved in db
        em.detach(updatedMarcas);
        updatedMarcas
